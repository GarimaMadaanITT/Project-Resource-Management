...
public class AdminUserService : IAdminUserService
{
    ...
    public Task<UserListItemDto> CreateAsync(CreateUserRequest request, CancellationToken cancellationToken = default) =>
        _provisioningService.CreateAsync(request, cancellationToken);
    ...
    public Task ResetPasswordAsync(int id, ResetPasswordRequest request, CancellationToken cancellationToken = default) =>
        _credentialService.ResetPasswordAsync(id, request, cancellationToken);
    ...
    public Task ReactivateAsync(int id, CancellationToken cancellationToken = default) =>
        _lifecycleService.ReactivateAsync(id, cancellationToken);
}
