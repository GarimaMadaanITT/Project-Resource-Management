...
public static class AllocationValidator
{
        ...
        ILogger? logger = null)
    {
        ...
        AllocationGuard.EnsureEmployeeCanReceiveAllocation(employee);
        ...
        ILogger? logger)
    {
        ...
        foreach (var date in criticalDates)
        {
            ...
            {
                logger?.LogWarning(
                    "Allocation rejected. EmployeeId={EmployeeId}, Date={Date}, ExistingUtilisation={Existing}, RequestedUtilisation={Requested}",
                    existingAllocations.FirstOrDefault()?.EmployeeId,
                    date,
                    existingTotal,
