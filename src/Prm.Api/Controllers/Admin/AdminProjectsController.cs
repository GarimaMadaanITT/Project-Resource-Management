...
public class AdminProjectsController : ControllerBase
{
    ...
    public AdminProjectsController(IAdminProjectService service)
    {
        _service = service;
    }
    ...
    public async Task<ActionResult<MilestoneDto>> AddMilestone(
        ...
        Ok(await _service.AddMilestoneAsync(id, request, cancellationToken));
    ...
    public async Task<ActionResult<MilestoneDto>> UpdateMilestoneStatus(
        ...
        CancellationToken cancellationToken) =>
        Ok(await _service.UpdateMilestoneStatusAsync(id, milestoneId, request, cancellationToken));
}
