...
public class AdminEmployeesController : AuthenticatedControllerBase
{
    ...
    {
        await _service.UpdateAsync(id, request, GetUserId(), cancellationToken);
    ...
    public async Task<ActionResult<EmployeeSkillDto>> AddSkill(
        ...
        CancellationToken cancellationToken) =>
        Ok(await _service.AddSkillAsync(id, request, GetUserId(), cancellationToken));
    ...
    public async Task<ActionResult<EmployeeSkillDto>> UpdateSkill(
        ...
        CancellationToken cancellationToken) =>
        Ok(await _service.UpdateSkillAsync(id, skillId, request, GetUserId(), cancellationToken));
    ...
    {
        await _service.RemoveSkillAsync(id, skillId, GetUserId(), cancellationToken);
    ...
    {
        await _service.AssignManagerAsync(id, request, GetUserId(), cancellationToken);
