...
public class AdminUserCredentialService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var oldSnapshot = AuditSnapshotBuilder.PasswordResetSnapshot(user.IsTemporaryPassword);

        user.PasswordHash = _passwordHasher.Hash(newPassword);
        user.IsTemporaryPassword = DomainDefaults.IsTemporaryPasswordOnReset;
        ...
        await _auditLog.AuditAsync(
            ...
            oldSnapshot,
            AuditSnapshotBuilder.PasswordResetSnapshot(user.IsTemporaryPassword),
            actingUserId,
